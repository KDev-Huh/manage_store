...
<body>
    <nav>
        <div class="board">
            <a href="https://www.instagram.com/yeohaenggil_souvenir_shop"  style="margin-top: 5px;"><div class="logo"><img src="../../image/메인_로고-배경제거.png"></div></a>
            ...
            <?php
                ...
                <div id='respond_box'>
                    <form action='significant_post.php' method='post'>
                        <textarea name='answer' id='respond' placeholder='텍스트 입력'>".$row['answer']."</textarea>
